          ...
          <div className="flex flex-col items-center gap-4 p-6 w-3/4 md:w-1/2 lg:w-1/3">
            ...
            <div className="flex flex-col items-center space-y-4 w-full max-w-md">
              <button
                ...
                className="w-3/4 px-6 py-3 text-white bg-blue-500 hover:bg-blue-600 rounded-lg shadow-md flex items-center justify-center space-x-2"
              >
                <span className="font-bold">Sign in with Google</span>
              </button>
              <button
                onClick={handleLinkedInSignIn}
                className="w-3/4 px-6 py-3 text-white bg-blue-700 hover:bg-blue-800 rounded-lg shadow-md flex items-center justify-center space-x-2"
              >
